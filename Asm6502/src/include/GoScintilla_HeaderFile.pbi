...
;-CONSTANTS.
  ...
  ;Delimiter flags.  
    Enumeration
      ...
      ;Add the following to have the delimiter not behave like a separator.
        #GOSCI_NONSEPARATINGDELIMITER                 = $00100000
    EndEnumeration

  ;Keywords flags.
    Enumeration
      #GOSCI_OPENFOLDKEYWORD                          = $01000000
      #GOSCI_CLOSEFOLDKEYWORD                         = $02000000
      #GOSCI_ADDTOCODECOMPLETION                      = $04000000
      ;For use with GOSCI_AddKeywordsEx() only.
        #GOSCI_ALLOWWHITESPACEPRECEEDINGOPENCALLTIP   = $08000000
    EndEnumeration
  ...
  ;Use with GOSCI_GetLexerState()/GOSCI_SetLexerState().
    Enumeration
      ...
      #GOSCI_LEXERSTATE_ENABLECALLTIPS        = 8
      #GOSCI_LEXERSTATE_ENABLEAUTOINDENTATION  = 16
    EndEnumeration
;/////////////////////////////////////////////////////////////////////////////////
